...
-- QUERYING THE EXISTING TABLES THAT WERE TAKEN FROM THE CSV FILES
-- AND PUTTING THEM INTO THE TABLES CREATED IN THE SECOND HALF
-- OF THE SCHEMATA FILE AND FILLING THE TABLES WITH THE REQUIRED DATA.
